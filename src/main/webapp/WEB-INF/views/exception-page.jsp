...
<main>
    <div class="container">
        ...
        <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
            ...
            <a class="btn" href="${contextRoot}/bidProducts">Back to home</a>
            <img src="${contextRoot}/styles/back/assets/img/not-found.svg" class="img-fluid py-5" alt="Page Not Found">
            <p class="copyright">
