              ...
              <div class="accordion-item">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                  ...
                  <div class="accordion-body">
                    <strong>您有兩種方式能夠聯絡到我們</strong><br>
                    <strong>1.您可在網頁右上角的客服中心回報表單與客服進行發問</strong><br>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="headingThree">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <strong>Q3、我一定要成為會員，才能在山西達人購物中訂購商品嗎？</strong>
                  </button>
                </h2>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="headingFour">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <strong>Q4、尚未註冊過山西達人會員，可以直接選擇第三方帳號登入嗎？</strong>
                  </button>
                </h2>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="headingFive">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <strong>Q5、15天鑑賞期</strong>
                  </button>
                </h2>
                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                  data-bs-parent="#accordionExample" style="background-color:#FFFACD;">
                  <div class="accordion-body">
                    <strong>根據消費者保護法之規定，除商品有消費者保護法第十九條第一項但書所規定之合理例外情事外，將提供您享有商品到貨15天猶豫期隨時解約退貨之權益，但提醒您注意，商品退貨時必須回復原狀，亦即必須回復至您收到商品時的原始狀態
                      ( 包含主機、附件、內外包裝、隨機文件、贈品等）。</strong><br>
                    <strong>此外，下列情形可能影響您的退貨權限：</strong><br>
                    <strong> (1)隨商品已附上相同之試用品，或在收到影音光碟及軟體前已提供您試聽、試用之機會。</strong><br>
                    <strong> (2)在不影響您檢查商品情形下，您將商品包裝毀損、封條移除、吊牌拆除、貼膠移除或標籤拆除等情形。</strong><br>
                    <strong> (3)在您收到商品之前，已提供您檢查商品之機會。</strong><br>
                    <strong> (4)其他逾越檢查之必要或可歸責於您之事由，致商品有毀損、滅失或變更者。</strong><br><br>
                    <strong>不適用鑑賞期</strong><br>
                    <strong>一、依消費者要求所為之客製化給付。如依消費者提供相片印製之商品、依消費者指示刻製之印章或依消費者身材特別縫製之服裝等；消費者依現有顏色或規格中加以指定或選擇者，以及需安裝之大型家電或是機車等，非屬本款所稱之客製化給付。 </strong><br>
                    <strong>二、非以有形媒介提供之數位內容或一經提供即為完成之線上服務。經消費者事先同意始提供，此種類型契約如係經消費者事先同意而開始提供，因其完成下載或服務經即時提供後即已履行完畢（例如：電子書、線上掃毒、序號已使用等）。</strong><br>
                    <strong>三、其餘定型化契約規範之商品者。（如：藝文展覽票券、藝文表演票券、線上遊戲等）。</strong><br><br>
                    <strong> 拆封無鑑賞期</strong><br>
                    <strong>一、經消費者拆封之影音商品或電腦軟體。以有形媒介提供之影音商品或電腦軟體經拆封後，處於可複製之狀態，性質上不易返還（例如：DVD、電腦軟體或電玩軟體等）</strong><br>
                  </div>
                </div>
              </div>
              <div class="accordion-item">
