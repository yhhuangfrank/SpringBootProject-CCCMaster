        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            ...
            <form:form method="post" modelAttribute="article"
             action="${contextRoot}/articles/create" enctype="multipart/form-data">
...
<%--              <form:textarea cssStyle="width: 720px;height: 500px" type="text" path="content"  class="quill-editor-full" id="inputContent"></form:textarea>--%>
<%--              <form:textarea type="text" path="content"  class="quill-editor-full" id="inputContent"></form:textarea>--%>
