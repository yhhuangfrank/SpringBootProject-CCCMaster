...
public class ServiceAdminController {
	...
	public String addMessage(Model model) {
    	...
    	model.addAttribute("messages", new chatModel());
    	
    	chatModel latest = mService.getLatest();
    ...
    public String postMessage(@ModelAttribute("messages") chatModel msg,Model model) {
