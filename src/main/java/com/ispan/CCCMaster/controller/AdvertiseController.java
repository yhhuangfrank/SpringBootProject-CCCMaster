...
//    public List<Integer> getAllProductImageId(Model model) {
//        Date now = new Date();
...
//            return products.stream().map(product -> product.getProductImgs().get(0).getProductImgId()).collect(Collectors.toList());
//
//
//
//
